...
public:
	...
	enum IECState {
		...
		errorFlag = (1 << 2)    // If this flag is set, a timeout or protocol error occurred.
	};
	...
	enum {
		DEFAULT_IEC_DEVICE = 4 // Printer device number
	};
	...
	void setPins(byte atn, byte clock, byte data);
